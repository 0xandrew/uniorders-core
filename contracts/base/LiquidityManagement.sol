...
abstract contract LiquidityManagement is IUniswapV3MintCallback {
    ...
    function burnAndCollect(
        ...
        (_amount0, _amount1) = pool.burn(tickLower, tickUpper, _liquidity);

        (_collect0, _collect1) = pool.collect(
            recipient,
            tickLower,
            tickUpper,
            type(uint128).max,
        ...
        return (
            amount0 = _amount0.add(_collect0),
            amount1 = _amount1.add(_collect1)
        );
    }
}
